...
- **Cutting log** — one tap to log a cut; come back and set the outcome (baled dry, rained on, made
  baleage). Over time the model calibrates dry-down to *your* fields.
...
The cutting log — especially logged **outcomes** — is the calibration path. See `CLAUDE.md` for the
model details, schema, and roadmap.
